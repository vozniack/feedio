...
@Component({
  selector: 'fe-select-input',
  standalone: true,
  imports: [IconComponent, NgForOf, NgIf],
...
export class SelectInputComponent {
  ...
  getOptionName(): string | undefined {
    return this.options.find(option => option.value === this.control.value)?.text;
  }
}
