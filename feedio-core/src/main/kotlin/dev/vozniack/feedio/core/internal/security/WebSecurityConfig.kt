package dev.vozniack.feedio.core.internal.security
...
class WebSecurityConfig(@Value("\${feedio.security.jwt.secret}") private val jwtSecret: String) : WebMvcConfigurer {
